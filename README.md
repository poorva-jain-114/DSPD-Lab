...
3. [Lab_1C : Write a program which creates a structure Student which must have the attribute Avg Marks with 3 more attributes sort the list of the student in descending order using Bubble sort.	](https://github.com/poorva-jain-114/DSPD-Lab/blob/main/Lab_1C/Lab_1C.c)

4. [Lab_2 :	Design, Develop and Implement a menu driven Program in C for the following operations on STACK of Integers (Array Implementation of Stack with maximum size MAX) 
...
5. [Lab_3 :	Design, Develop and Implement a menu driven Program in C for the following operations on QUEUE of Characters (Array Implementation of Queue with maximum size MAX)
...
8. [Lab_6: Binary_Search_Tree_operations](https://github.com/poorva-jain-114/DSPD-Lab/blob/main/Lab_6/Lab_6.c)](https://github.com/poorva-jain-114/DSPD-Lab/blob/main/Lab_6/Lab_6.c)
